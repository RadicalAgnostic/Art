...
This version prints rainbow circles in spiral motion
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            ...
            xmove = move*cos(theta)
            ymove = move*sin(theta)
    
            pos1 = (mousex + xmove, mousey + ymove)
    
        
            drawCircle(color,pos1,radius,border_size,border_color,ring)

            if old_mouse == (mousex, mousey):
                move = 30
                
            else:
                move = 0
                
            old_mouse = (mousex,mousey)
    ...
    if play == True:
        ...
        t = random.randint(0,10)     # for a random color value
        w = random.randint(0,360)    # for a random theta
        u = w  * (2*pi/360)          # degrees to radians
        
        
        
        color = funkyMath(last_color + 1)
        last_color += 1
