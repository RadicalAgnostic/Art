...
circle_data2 = [starting_pos2, 0, 0]
circle_data3 = [starting_pos3, 0, 0]
circle_data4 = [starting_pos4, 0, 0]
circle_data5 = [starting_pos5, 0, 0]
circle_data6 = [starting_pos6, 0, 0]
circle_data7 = [starting_pos7, 0, 0]
...
while running:
    ...
    if play_Loop1 == True:
        ...
        circle_data1 = autoDraw(slow_rainbow, white, 0, circle_data1[0], \
                movement = guided_down, length = 10000000, circle_count = circle_data1[1], \
    ...
    if play_Loop2 == True:
        ...
        for i in range(0,100000):
            ...
            circle_data7 = autoDraw(black, black, 50, circle_data7[0], \
                    movement = random_total, length = 100000, circle_count = circle_data7[1],\
